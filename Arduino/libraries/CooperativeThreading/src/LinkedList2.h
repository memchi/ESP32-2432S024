/* -----------------------------------------------------------------------------
  ...
  --------------------------------------------------------------------------- */
#pragma once
//#pragma message("Replace this by own code in CoThreadList.h/.cpp")
// -----------------------------------------------------------------------------
#include <stddef.h>
// -----------------------------------------------------------------------------
template<class T>
...
public:
  ...
  virtual int size();
  // Adds a T object in the specified index; Unlink and link the LinkedList correcly; Increment _size
